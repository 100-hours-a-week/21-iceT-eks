...
sudo /usr/local/openvpn_as/scripts/sacli --key "vpn.server.routing.private_network.0" --value "10.120.0.0/16" ConfigPut
...
sudo /usr/local/openvpn_as/scripts/sacli --key "vpn.server.nat.netmask.0" --value "10.120.0.0/16" ConfigPut
